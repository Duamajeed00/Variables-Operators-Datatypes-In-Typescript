...
let fullName = "Dua Majeed";
let favouriteFruit = "strawberry";
let cityOfLiving = "Karachi";
console.log(`My full name is${fullName} ,my favourite fruit is${favouriteFruit} and i dwell in the "City Of Lights"${cityOfLiving}`);

// // What is Boolean
let fullNames = "Dua Majeed";
